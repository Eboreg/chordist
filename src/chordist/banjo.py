...
BASE_CHORDS = InstrumentChordCollection(
    ...
    BanjoChord.create("A", (1, 1, 1), (2, 2, 2), (2, 3, 2), (2, 4, 2)),
    BanjoChord.create("A⁷", (2, 1, 1), (2, 2, 1), (2, 3, 1), (2, 4, 1)),
    ...
    BanjoChord.create("C", (1, 3, 1), (2, 4, 2)),
    ...
    BanjoChord.create("C⁷", (5, 2, 1), (5, 3, 1), (8, 1, 2)),
    ...
    BanjoChord.create("F", (1, 3, 1), (2, 2, 2), (3, 4, 3)),
    ...
    BanjoChord.create("G⁷", (2, 1, 1), (3, 4, 2)),
