...
class Banjo(AbstractInstrument):
    ...
    base_chords = [
        ...
        BanjoChord("D", (2, 2, 1), (3, 3, 2), (4, 4, 4)),
        ...
        BanjoChord("G"),
        BanjoChord("G⁷", (3, 4, 3)),
        BanjoChord("Gm", (3, 2, 1), (3, 3, 1), (5, 1, 3), (5, 4, 4)),
    ]
